...
import portal from '../images/portalnetwork.png';
    ...
    const clients =
      <div className="main">
        <div className="introduction">
          ...
          <p>BNS resolver enables any users to easily set the default resolver contract and bind its BNS with an IPFS hash. Below image is the first WNS resolver built by Portal Network for Ethereum Name Service, which helps both the WNS and IPFS communities to easily connect their DWeb with the WNS.</p>
        </div>
        <div className="wallet">
          ...
          <a href="javascript:;" className="wallet_list"><img src={portal} alt="" /><p>PortalNetwork</p></a>
        </div>
      </div>;
